...
public class copyBootsound extends BroadcastReceiver {

    private static final String TAG = "CMBootsound-Copy";
    public static final String cpyBg = "com.cyanogenmod.cmbootsound.COPY_BOOTSOUND";
        ...
        if (intent.getAction().equals(cpyBg)) {
            ...
            if (fromFile.exists()) {
                try {
                    ...
                    FileOutputStream outfile = context.openFileOutput("poweron.ogg", Context.MODE_WORLD_READABLE);
